    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form id="formSPT" action="{{ route('spt.store') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="step" id="step1">
                            ...
                            <div id="tujuanContainer">
                                @php
                                    $oldJenisTujuan = old('jenis_tujuan', ['']);
                                    $oldPoktanTujuan = old('tujuan_poktan', ['']);
                                    $oldKabKotaTujuan = old('tujuan_kabupaten', ['']);
                                    $oldLainnyaTujuan = old('tujuan_lainnya', ['']);
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="alat_angkut" id="alat_angkut" class="form-control"
                                    value="{{ old('alat_angkut') }}" required data-field-name="alat_angkut">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="berangkat_dari" id="berangkat_dari" class="form-control"
                                    value="{{ old('berangkat_dari') }}" required data-field-name="berangkat_dari">
                            </div>

                            <div class="form-group">
                                <label for="keperluan">Keperluan</label>
                                <textarea name="keperluan" id="keperluan" rows="3" class="form-control" required data-field-name="keperluan">{{ old('keperluan') }}</textarea>
                            </div>
                        ...
                        <div class="step d-none" id="step2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_berangkat" name="tanggal_berangkat"
                                    class="form-control" value="{{ old('tanggal_berangkat') }}" required
                                    data-field-name="tanggal_berangkat">
                            </div>

                            <div class="form-group">
                                <label for="tanggal_kembali">Tanggal Kembali</label>
                                <input type="date" id="tanggal_kembali" name="tanggal_kembali" class="form-control"
                                    value="{{ old('tanggal_kembali') }}" required data-field-name="tanggal_kembali">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kehadiran" id="kehadiran" class="form-control"
                                    value="{{ old('kehadiran') }}" required data-field-name="kehadiran">
                            </div>
                        ...
                        <div class="step d-none" id="step3">
                            ...
                            <div class="alert alert-secondary">
                                <div><strong>Nomor surat terakhir:</strong> {{ $lastNomorSurat ?? '-' }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_surat_input" id="nomor_surat_input"
                                    class="form-control" value="{{ old('nomor_surat_input') }}" required
